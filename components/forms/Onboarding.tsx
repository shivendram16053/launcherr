...
export default function OnboardingForm() {
  ...
  const checkPublicKey = async () => {
    ...
    if (!publicKey) {
      setLoading(false); // No public key, show onboarding form
      return;
    }

    try {
      const res = await fetch(`/api/users/check?publicKey=${publicKey}`);
              ...
              >
                {currentStep === 0 && (
                  <div className="space-y-4">
                    ...
                    <p className="text-sm text-zinc-400">
                      Just a few steps left to unlock{" "}
                    ...
                    <Button
                      ...
                      type="button"
                      onClick={handleNext}
                      className=" bg-zinc-100 text-zinc-900 w-full hover:bg-zinc-200 font-semibold"
                    >
                      Get Started{" "}
                      <ChevronRight className="font-semibold ml-0.5 h-4 w-4" />
                    </Button>
                  </div>
                )}
                {currentStep === 1 && (
                  <div className="space-y-4">
                    ...
                    <div className="relative">
                      ...
                      <AtSign className="absolute left-2 top-9 h-4 w-4 text-zinc-400" />
                ...
                {currentStep === 2 && (
                  <div className="space-y-4">
                    ...
                    <div className="space-y-2">
                      <Label htmlFor="twitter" className="text-zinc-100">
                        Twitter Handle
                      </Label>
                      <div className="relative">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="pt-4">
                      <Button
                        ...
                        disabled={formData.ageVerified !== true}
                      >
